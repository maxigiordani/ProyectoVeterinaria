            ...
            <Col className="servicesandproduct">
              ...
              <Link className="linkstyle" to="/page404">
                <Card className="cardservice">
                  <Card.Body>
                    <Card.Title>
                      Alimentos balanceados de varias marcas
                    </Card.Title>
                  </Card.Body>
                </Card>
              </Link>
              ...
              <Card className="cardprof">
                <Card.Body >
                  ...
                  <Card.Text>
                    ...
                    de experiencia al servicio del cuidado de los animales
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card className="cardprof">
                <Card.Body>
                  ...
                  <Card.Text>
                    Especialista en cirugía general, tiene más de 15 años
                    realizando intervenciones de diferentes tipos.
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card className="cardprof">
                <Card.Body>
                  ...
                  <Card.Text>
                    Especialista en oncología, trabaja hace 5 años en nuestra
                    veterinaria.
                  </Card.Text>
                </Card.Body>
              </Card>
