...
const AboutUs = () => {
  return (
    <Container className="mt-5 text-center containerpage">
      ...
      <h3 className="h3 text-center fraseequipo">
        ¡Unidos en cada desafío, creamos el éxito juntos!
      </h3>
      ...
      <Row className="justify-content-center">
        <Col>
          <Image
            ...
            src={Integrante1Avatar}
            alt="Avatar Integrante 1"
            roundedCircle
            fluid
          />
        ...
        <Col>
          <Image
            className="imagenavatar"
            src={Integrante2Avatar}
            alt="Avatar Integrante 2"
            roundedCircle
            fluid
          />
        ...
        <Col>
          <Image
            className="imagenavatar"
            src={Integrante3Avatar}
            alt="Avatar Integrante 3"
            roundedCircle
            fluid
          />
